...
// Shared "virtual joystick" math: turns the mouse's offset from the screen center
// into a deadzone-adjusted (x = yaw, y = pitch) intent in the range [-1, 1].
public static class VirtualJoystickMath
{
    public static Vector2 CalculateRawIntent(float deadzoneRadius)
    {
        ...
        // Ramps from 0 right at the edge of the deadzone up to max speed at the edge of the screen.
